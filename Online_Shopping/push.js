...
const featurePush = (pId, newFeature) =>{
    const index = products.findIndex(products => products.productId === pId);
    products[index].features.push(newFeature);
    return products[index].features;
    
};

console.log(featurePush(2,"Instant glow"));
