const products = [
    ...
    },
    {
        ...
        category: "Cosmetics",
        price: 500,
        features: ["SPF 50 PA+++", "UVA & UVB Protection", "Water Resistant", "Non-Greasy", "Lightweight"],
        reviews: {
            "Praveen": 5,
            "Jeeva": 4,
            "kalai": 5,
        ...
        specs: {
            skinType: ["All Skin Types"],
            quantity: ["50ml"],
            ingredients: ["Aloe Vera", "Vitamin E", "Zinc Oxide"],
            SPF: ["50+"],
            PA: ["+++ "]
        }
    }
...
console.log(categoryFilter("Cosmetics"));