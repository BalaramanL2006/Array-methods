...
const featureSplice = (product) =>{
    const index =product.features.indexOf("Breathable");
    
    return product.features.splice(index,2,"Flexible",
    "Cushioned");
}
console.log(featureSplice(products[1]));
